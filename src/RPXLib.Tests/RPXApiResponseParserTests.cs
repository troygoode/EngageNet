...
namespace RPXLib.Tests
{
	...
	public class RPXApiResponseParserTests
	{
		...
		[Test]
		[ExpectedException(typeof (RPXPreviouslyOperationalProviderException),
		...
		[Test]
		[ExpectedException(typeof (RPXCredentialsMissingException),
		...
		[Test]
		[ExpectedException(typeof (RPXAccountUpgradeNeededException),
		...
		[Test]
		[ExpectedException(typeof (RPXServiceTemporarilyUnavailableException),
		...
		[Test]
		[ExpectedException(typeof (RPXUnsupportedProviderFeatureException),
		...
		[Test]
		[ExpectedException(typeof (RPXCredentialsRevokedException),
		...
		[Test]
		[ExpectedException(typeof (RPXTokenUrlMismatchException),
		...
		[Test]
		[ExpectedException(typeof (RPXApplicationConfigurationException),
